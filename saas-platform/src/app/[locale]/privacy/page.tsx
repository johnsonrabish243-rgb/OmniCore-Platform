...
export default function PrivacyPage() {
  ...
  const sections = [
    { icon: Eye, title: t("privacySection1Title"), content: t("privacySection1Content") },
    { icon: Database, title: t("privacySection2Title"), content: t("privacySection2Content") },
    { icon: Lock, title: t("privacySection3Title"), content: t("privacySection3Content") },
    { icon: Globe, title: t("privacySection4Title"), content: t("privacySection4Content") },
    { icon: Shield, title: t("privacySection5Title"), content: t("privacySection5Content") },
    { icon: Database, title: t("privacySection6Title"), content: t("privacySection6Content") },
    { icon: Mail, title: t("privacySection7Title"), content: t("privacySection7Content") },
  ];
  return (
      ...
      <section className="relative pt-32 sm:pt-40 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <ScrollReveal delay={100}><div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-gradient-to-r from-primary/10 to-purple-500/10 px-4 py-1.5 text-sm font-medium text-primary mb-6 shadow-sm"><Shield className="h-4 w-4" /><span>{t("privacyBadge")}</span></div></ScrollReveal>
            <ScrollReveal delay={200}><h1 className="text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">{t("privacyTitle")}</h1></ScrollReveal>
            <ScrollReveal delay={300}><p className="mt-6 text-lg text-muted-foreground">{t("privacyLastUpdated")}: {new Date().toLocaleDateString(locale)}</p></ScrollReveal>
          </div>
        </div>
      </section>
